...
def best_letter_for_pets() -> str:
    ...
    for i in the_alphabet:
        pets = pet_filter(i)
        most_pets.append(len(pets))

    letter_index = most_pets.index(max(most_pets))
    most_popular_letter = alphabet_list[letter_index]
